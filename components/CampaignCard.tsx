    ...
    >
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        <div className="mt-auto">
            ...
            <Link to={`/donate?campaign=${campaign.id}`} className="mt-4 w-full text-center inline-block bg-brand-gold text-white font-bold py-2 px-4 rounded-md hover:bg-brand-gold/90 transition-colors">
                Donate Now
            </Link>
        </div>
      </div>
